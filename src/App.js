        ...
        {categories.map((category) => (
          <Link
            ...
            className={`p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 
              ${darkMode ? 'bg-gray-700 hover:bg-gray-600' : 'bg-white hover:bg-blue-50'} 
              border-l-4 ${getCategoryBorderColor(category)} card-hover`}
          >
            <div className="flex flex-col items-center">
              <div className={`text-4xl mb-3 ${getCategoryIconColor(category)}`}>
